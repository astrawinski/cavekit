...
_Generated from `commands/sketch.md`. Upstream command docs are canonical; this file is the Codex-native reading surface._
...
Parse `<text after the skill invocation>`:
