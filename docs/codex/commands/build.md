...
_Generated from `commands/build.md`. Upstream command docs are canonical; this file is the Codex-native reading surface._
...
```!
"<local Cavekit plugin root>/scripts/setup-build.sh" <text after the skill invocation>
```
