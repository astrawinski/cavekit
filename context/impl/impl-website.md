...
| T-004 | DONE | How It Works: 4 Hunt phase cards. |
...
| T-012 | DONE | Docs content: Overview (what Cavekit is, Hunt summary with links) + Quick Start (Greenfield + Brownfield annotated examples). |
...
| T-014 | DONE | Docs content: Hunt Lifecycle walkthrough, Kits as Source of Truth, Scientific Method Applied mapping. |
